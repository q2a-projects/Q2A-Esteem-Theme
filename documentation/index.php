...
<body>
	...
	<div class="section sTop">
		...
		<div class="inner">
			<h1>Esteem Theme - Premium Q2A Theme </h1>
	...
	<div class="section s1">
		...
		<div class="inner">
			...
			<ol>
				<li><p>Extract <strong>esteem-theme.zip</strong>.</p></li>
				<li>upload Content of <strong>esteem-theme</strong> directory to <strong>qa-themes/</strong> directory in your Q2A site</li>
				<li><p>Log in as Administrator, then Go to <strong>Admin &gt; General</strong> and select 'Esteem-Theme' as your default theme.</p></li>
			...
			<h3>Making your site like our <a href="http://demo.qa-themes.com/support/">demo</a></h3>
	...
	<div class="section s2">
		<div class="inner">
			<p><strong>Esteem Theme</strong> offers a wide range of customizations that you can easily apply on your theme.</p>
	...
	<div class="section s3">
		...
		<p>you have more backgrounds that you want to try on your theme? simply save them as .png files and upload the file in 'qa-themes/esteem-theme/patterns' and it will be added to backgrounds list.</p>
		...
		<p>to add a new CSS file you can upload it in 'qa-themes/esteem-theme/styles' or you can edit one of pre-made styles.</p>
		</div>
